function calcAcceleration() {
	...
	if (modeActive("easy")) { tmp.acc = tmp.acc.mul(2); }
	if (player.rank.gt(2))  { tmp.acc = tmp.acc.mul(rankEffects(2)); }
	if (player.rank.gt(3))  { tmp.acc = tmp.acc.mul(2); }
	if (player.tier.gt(1) && player.rank.gte(3)) { tmp.acc = tmp.acc.mul(2); }
	if (player.rank.gt(4))  { tmp.acc = tmp.acc.mul(rankEffects(4)); }
	if (player.rank.gt(5))  { tmp.acc = tmp.acc.mul(rankEffects(5)); }
	if (player.rank.gt(10)) { tmp.acc = tmp.acc.mul(2); }
	if (player.tier.gt(3))  { tmp.acc = tmp.acc.mul(3); }
	if (player.rank.gt(14)) { tmp.acc = tmp.acc.mul(rankEffects(14)); }
	if (player.rank.gt(15)) { tmp.acc = tmp.acc.mul(4); }
	if (player.tier.gt(5))  { tmp.acc = tmp.acc.mul(5); }
	if (player.rank.gt(25)) { tmp.acc = tmp.acc.mul(10); }
	if (player.rank.gt(50)) { tmp.acc = tmp.acc.mul(15); }
	if (player.tier.gt(8))  { tmp.acc = tmp.acc.mul(10); }
	if (player.tier.gt(10)) { tmp.acc = tmp.acc.mul(15); }
	if (player.rank.gt(75)) { tmp.acc = tmp.acc.mul(25); }
	if (player.tier.gt(15)) { tmp.acc = tmp.acc.mul(25); }
	if (tmp.ach) if (tmp.ach[12].has)  { tmp.acc = tmp.acc.mul(1.1);  }
	if (tmp.ach) if (tmp.ach[22].has)  { tmp.acc = tmp.acc.mul(1.05); }
	if (tmp.ach) if (tmp.ach[23].has)  { tmp.acc = tmp.acc.mul(1.2);  }
	if (tmp.ach) if (tmp.ach[14].has)  { tmp.acc = tmp.acc.mul(1.5);  }
	if (tmp.ach) if (tmp.ach[32].has)  { tmp.acc = tmp.acc.mul(1.8);  }
	if (tmp.ach) if (tmp.ach[35].has)  { tmp.acc = tmp.acc.mul(1.8);  }
	if (tmp.ach) if (tmp.ach[105].has) { tmp.acc = tmp.acc.mul(4);    }
	if (tmp.ach) if (tmp.ach[24].has && modeActive("extreme")) {tmp.acc = tmp.acc.mul(ExpantaNum.pow(2, player.achievements.filter(x => x.toString().charAt(x.toString().length-1)==4).length));}
	if (tmp.maxVel && tmp.inf) if (tmp.inf.upgs.has("6;6")) {tmp.acc = tmp.acc.mul(INF_UPGS.effects["6;6"]());}
	if (tmp.inf && tmp.timeSpeed) if (tmp.inf.upgs.has("4;7")) {tmp.acc = tmp.acc.mul(INF_UPGS.effects["4;7"]());}
	if (tmp.rockets) {tmp.acc = tmp.acc.mul(tmp.rockets.accPow);}
	...
	if (extremeStadiumActive("nullum")) {tmp.acc = ExpantaNum.pow(10, tmp.acc.log10().mul(0.4-0.05*(extremeStadDiffLevel("nullum")-1)))}
